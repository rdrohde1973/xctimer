...
WAIVER_FIELDS = ("athlete_name", "school", "grade", "district", "date", "dob",
                 ...
                 "emergency_name", "emergency_phone", "xc_check", "track_check")
...
_WAIVER_TPL_SYS = (
    ...
    "For a sport checkbox line (e.g. '☐ Cross Country  ☐ Track & Field'), replace the "
    "Cross Country checkbox with {{xc_check}} and the Track (& Field) checkbox with "
    "{{track_check}}, keeping the sport label right after each. "

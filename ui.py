...
table.dense th,table.dense td{padding:.15rem .5rem;white-space:nowrap;vertical-align:middle}
...
table.dense select{width:auto;padding:.05rem .3rem;font-size:.82rem;height:24px}
table.dense button{padding:.1rem .45rem;font-size:.8rem;line-height:1.2}
